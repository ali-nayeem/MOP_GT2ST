 ...
 * Constructor
 */
DominanceDistComparator::DominanceDistComparator() : Comparator()
{
 ...
 * Destructor
 */
DominanceDistComparator::~DominanceDistComparator()
{
 ...
 * respectively.
**/
int DominanceDistComparator::compare(void *o1, void *o2)
{
  ...
  for (int i = 0; i < 2; i++)
  {
    value1 = one->getDistToRef(i);
    value2 = two->getDistToRef(i);
    if (value1 < value2)
    {
      flag = -1;
    }
