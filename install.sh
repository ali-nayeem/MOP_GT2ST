...
sudo apt-get install cmake autotools-dev autoconf libtool
...
export CPATH=$CPATH:$SCRIPTPATH/lib/Bpp/include 
export LIBRARY_PATH=$LIBRARY_PATH:$SCRIPTPATH/lib/Bpp/lib 
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$SCRIPTPATH/lib/Bpp/lib
...
sudo ./configure --prefix=$SCRIPTPATH/lib/Pll/src
...
export CPATH=$CPATH:$SCRIPTPATH/lib/Pll/src/include
export LIBRARY_PATH=$LIBRARY_PATH:$SCRIPTPATH/lib/Pll/src/lib 
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$SCRIPTPATH/lib/Pll/src/lib 
