filepath = "estimated-genetrees_FN_score_37-taxon.txt"
...
with open(filepath) as fp:  
	...
	while line:
		...
		#hy3.append(float(vals[3].split('>')[-1]))
		line = fp.readline()
...
plt.title('Comparison of FN rate between ASTRAL and PhyloNet')
...
#grid
plt.grid(axis='y')
plt.savefig('37-taxon_barchart.png')
